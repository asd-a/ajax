...
function(e, t) {
	...
	w.fn = w.prototype = {
		...
		var e, t, n, r, i, o = arguments[0] || {},
			...
			a = arguments.length,
			u = !1;
		for ("boolean" == typeof o && (u = o, o = arguments[s] || {}, s++), "object" == typeof o || w.isFunction(o) || (o = {}), s === a && (o = this, s--); s < a; s++) if (null != (e = arguments[s])) for (t in e) i = o[t], o !== (n = e[t]) && (u && n && (w.isPlainObject(n) || (r = w.isArray(n))) ? (i = r ? (r = !1, i && w.isArray(i) ? i : []) : i && w.isPlainObject(i) ? i : {}, o[t] = w.extend(u, i, n)) : void 0 !== n && (o[t] = n));
		return o
	}, w.extend({
		...
		globalEval: function(e) {
			var t, n = eval;
			(e = w.trim(e)) && (1 === e.indexOf("use strict") ? ((t = v.createElement("script")).text = e, v.head.appendChild(t).parentNode.removeChild(t)) : n(e))
		},
		...
		proxy: function(e, t) {
			var n, r;
			if ("string" == typeof t && (r = e[t], t = e, e = r), w.isFunction(e)) return n = c.call(arguments, 2), (r = function() {
	...
	var d = function(n) {
			...
			var e, d, b, o, t, h, p, g, w, l, c, m, T, r, y, v, i, s, x, C = "sizzle" + -new Date,
				N = n.document,
				k = 0,
				E = 0,
				a = ie(),
			...
			}, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = /'|\\/g, ne = new RegExp("\\\\([\\da-f]{1,6}" + R + "?|(" + R + ")|.)", "ig");
			try {
			...
			function re(e, t, n, r) {
				...
				if ((t ? t.ownerDocument || t : N) !== T && m(t), n = n || [], !e || "string" != typeof e) return n;
				if (1 !== (s = (t = t || T).nodeType) && 9 !== s) return [];
				if (y && !r) {
					if (i = Z.exec(e)) if (l = i[1]) {
						if (9 === s) {
							if (!(o = t.getElementById(l)) || !o.parentNode) return n;
							if (o.id === l) return n.push(o), n
						} else if (t.ownerDocument && (o = t.ownerDocument.getElementById(l)) && x(t, o) && o.id === l) return n.push(o), n
					} else {
						if (i[2]) return O.apply(n, t.getElementsByTagName(e)), n;
						if ((l = i[3]) && d.getElementsByClassName && t.getElementsByClassName) return O.apply(n, t.getElementsByClassName(l)), n
					}
					if (d.qsa && (!v || !v.test(e))) {
						if (c = l = C, f = t, p = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
							for (u = h(e), (l = t.getAttribute("id")) ? c = l.replace(te, "\\$&") : t.setAttribute("id", c), c = "[id='" + c + "'] ", a = u.length; a--;) u[a] = c + pe(u[a]);
							f = ee.test(e) && ce(t.parentNode) || t, p = u.join(",")
						}
						if (p) try {
							return O.apply(n, f.querySelectorAll(p)), n
						} catch (e) {} finally {
			...
			for (e in d = re.support = {}, t = re.isXML = function(e) {
				e = e && (e.ownerDocument || e).documentElement;
				return !!e && "HTML" !== e.nodeName
			}, m = re.setDocument = function(e) {
				var u = e ? e.ownerDocument || e : N,
					e = u.defaultView;
				return u !== T && 9 === u.nodeType && u.documentElement ? (r = (T = u).documentElement, y = !t(u), e && e !== e.top && (e.addEventListener ? e.addEventListener("unload", function() {
					m()
				}, !1) : e.attachEvent && e.attachEvent("onunload", function() {
					m()
				})), d.attributes = se(function(e) {
					return e.className = "i", !e.getAttribute("className")
				}), d.getElementsByTagName = se(function(e) {
					return e.appendChild(u.createComment("")), !e.getElementsByTagName("*").length
				}), d.getElementsByClassName = K.test(u.getElementsByClassName) && se(function(e) {
					return e.innerHTML = "<div class='a'></div><div class='a i'></div>", e.firstChild.className = "i", 2 === e.getElementsByClassName("i").length
				}), d.getById = se(function(e) {
				...
				}, i = [], v = [], (d.qsa = K.test(u.querySelectorAll)) && (se(function(e) {
					e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && v.push("[*^$]=" + R + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || v.push("\\[" + R + "*(?:value|" + M + ")"), e.querySelectorAll(":checked").length || v.push(":checked")
				}), se(function(e) {
				...
				})), (d.matchesSelector = K.test(s = r.matches || r.webkitMatchesSelector || r.mozMatchesSelector || r.oMatchesSelector || r.msMatchesSelector)) && se(function(e) {
					d.disconnectedMatch = s.call(e, "div"), s.call(e, "[s!='']:x"), i.push("!=", I)
				}), v = v.length && new RegExp(v.join("|")), i = i.length && new RegExp(i.join("|")), e = K.test(r.compareDocumentPosition), x = e || K.test(r.contains) ?
				function(e, t) {
				...
				function(e, t) {
					...
					return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !d.sortDetached && t.compareDocumentPosition(e) === n ? e === u || e.ownerDocument === N && x(N, e) ? -1 : t === u || t.ownerDocument === N && x(N, t) ? 1 : l ? P.call(l, e) - P.call(l, t) : 0 : 4 & n ? -1 : 1)
				} : function(e, t) {
					if (e === t) return c = !0, 0;
					var n, r = 0,
						i = e.parentNode,
						...
						s = [e],
						a = [t];
					if (!i || !o) return e === u ? -1 : t === u ? 1 : i ? -1 : o ? 1 : l ? P.call(l, e) - P.call(l, t) : 0;
					if (i === o) return ue(e, t);
					for (n = e; n = n.parentNode;) s.unshift(n);
					for (n = t; n = n.parentNode;) a.unshift(n);
					for (; s[r] === a[r];) r++;
					return r ? ue(s[r], a[r]) : s[r] === N ? -1 : a[r] === N ? 1 : 0
				}, u) : T
			}, re.matches = function(e, t) {
				return re(e, null, null, t)
			}, re.matchesSelector = function(e, t) {
				if ((e.ownerDocument || e) !== T && m(e), t = t.replace(U, "='$1']"), d.matchesSelector && y && (!i || !i.test(t)) && (!v || !v.test(t))) try {
					var n = s.call(e, t);
				...
				filter: {
						...
						function(e) {
							...
							if (c) {
								...
								if (u = [y ? c.firstChild : c.lastChild], y && p) {
									for (a = (r = (i = c[C] || (c[C] = {}))[d] || [])[0] === k && r[1], s = r[0] === k && r[2], o = a && c.childNodes[a]; o = ++a && o && o[l] || (s = a = 0) || u.pop();) if (1 === o.nodeType && ++s && o === e) {
										i[d] = [k, a, s];
										break
									}
								} else if (p && (r = (e[C] || (e[C] = {}))[d]) && r[0] === k) s = r[1];
								else for (;
								(o = ++a && o && o[l] || (s = a = 0) || u.pop()) && ((v ? o.nodeName.toLowerCase() !== f : 1 !== o.nodeType) || !++s || (p && ((o[C] || (o[C] = {}))[d] = [k, s]), o !== e)););
					...
					PSEUDO: function(e, o) {
						...
						return s[C] ? s(o) : 1 < s.length ? (t = [e, e, "", o], b.setFilters.hasOwnProperty(e.toLowerCase()) ? oe(function(e, t) {
							for (var n, r = s(e, o), i = r.length; i--;) e[n = P.call(e, r[i])] = !(t[n] = r[i])
						}) : function(e) {
							return s(e, 0, t)
						}) : s
					}
			...
			function me(d, h, g, m, y, e) {
				return m && !m[C] && (m = me(m)), y && !y[C] && (y = me(y, e)), oe(function(e, t, n, r) {
					var i, o, s, a = [],
						u = [],
						l = t.length,
						c = e ||
					function(e, t, n) {
						...
						return n
					}(h || "*", n.nodeType ? [n] : n, []), f = !d || !e && h ? c : ge(c, a, d, n, r), p = g ? y || (e ? d : l || m) ? [] : t : f;
					if (g && g(f, p, n, r), m) for (i = ge(p, u), m(i, [], n, r), o = i.length; o--;)(s = i[o]) && (p[u[o]] = !(f[u[o]] = s));
					if (e) {
						if (y || d) {
							if (y) {
							...
							for (o = p.length; o--;)(s = p[o]) && -1 < (i = y ? P.call(e, s) : a[o]) && (e[i] = !(t[i] = s))
						}
					} else p = ge(p === t ? p.splice(l, p.length) : p), y ? y(null, t, p, r) : O.apply(t, p)
				})
			}
			function ye(m, y) {
				function e(e, t, n, r, i) {
					...
					if (u += l, v && l !== u) {
						...
						O.apply(r, f), i && !e && 0 < f.length && 1 < u + y.length && re.uniqueSort(r)
					}
					return i && (k = h, w = p), c
				}
				var v = 0 < y.length,
			...
			return fe.prototype = b.filters = b.pseudos, b.setFilters = new fe, h = re.tokenize = function(e, t) {
				...
				if (!o) {
					for (n = (t = t || h(e)).length; n--;)((o = function e(t) {
						...
						}]; u < o; u++) if (n = b.relative[t[u].type]) f = [de(he(f), n)];
						else {
							if ((n = b.filter[t[u].type].apply(null, t[u].matches))[C]) {
								for (i = ++u; i < o && !b.relative[t[i].type]; i++);
								return me(1 < u && he(f), 1 < u && pe(t.slice(0, u - 1).concat({
									value: " " === t[u - 2].type ? "*" : ""
				...
				if (n = n || [], 1 === c.length) {
					if (2 < (o = c[0] = c[0].slice(0)).length && "ID" === (s = o[0]).type && d.getById && 9 === t.nodeType && y && b.relative[o[1].type]) {
				...
				return (l || p(e, c))(r, t, !y, n, ee.test(e) && ce(t.parentNode) || t), n
			}, d.sortStable = C.split("").sort(j).join("") === C, d.detectDuplicates = !! c, m(), d.sortDetached = se(function(e) {
	...
	(w.fn.init = function(e, t) {
		var n, r;
		if (!e) return this;
		if ("string" != typeof e) return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : w.isFunction(e) ? void 0 !== N.ready ? N.ready(e) : e(w) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), w.makeArray(e, this));
		if (!(n = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : k.exec(e)) || !n[1] && t) return (!t || t.jquery ? t || N : this.constructor(t)).find(e);
		if (n[1]) {
			if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), b.test(n[1]) && w.isPlainObject(t)) for (n in t) w.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
			return this
		}
	...
	w.extend({
		...
		w.fn[r] = function(e, t) {
			...
			return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = w.filter(t, n)), 1 < this.length && (S[r] || w.unique(n), E.test(r) && n.reverse()), this.pushStack(n)
		}
	});
	var D, A = /\S+/g,
		L = {};
	...
	function q() {
		v.removeEventListener("DOMContentLoaded", q, !1), h.removeEventListener("load", q, !1), w.ready()
	}
	w.Callbacks = function(i) {
		...
		ready: function(e) {
			(!0 === e ? --w.readyWait : w.isReady) || (w.isReady = !0) !== e && 0 < --w.readyWait || (D.resolveWith(v, [w]), w.fn.triggerHandler && (w(v).triggerHandler("ready"), w(v).off("ready")))
		}
	}), w.ready.promise = function(e) {
		return D || (D = w.Deferred(), "complete" === v.readyState ? setTimeout(w.ready) : (v.addEventListener("DOMContentLoaded", q, !1), h.addEventListener("load", q, !1))), D.promise(e)
	}, w.ready.promise();
	...
	w.extend({
		...
		data: function(r, e) {
			...
			if (void 0 !== r) return "object" == typeof r ? this.each(function() {
				...
				if (o && void 0 === t) return void 0 !== (e = P.get(o, r)) || void 0 !== (e = P.get(o, n)) || void 0 !== (e = W(o, n, void 0)) ? e : void 0;
				this.each(function() {
					var e = P.get(this, n);
		...
		queue: function(e, t, n) {
			var r;
			if (e) return t = (t || "fx") + "queue", r = F.get(e, t), n && (!r || w.isArray(n) ? r = F.access(e, t, w.makeArray(n)) : r.push(n)), r || []
		},
	...
	var n = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		I = /^(?:checkbox|radio)$/i;
	s = v.createDocumentFragment().appendChild(v.createElement("div")), (d = v.createElement("input")).setAttribute("type", "radio"), d.setAttribute("checked", "checked"), d.setAttribute("name", "t"), s.appendChild(d), y.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked, s.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !! s.cloneNode(!0).lastChild.defaultValue;
	var _ = "undefined";
	...
	w.event = {
		...
		trigger: function(e, t, n, r) {
			...
			if (3 !== n.nodeType && 8 !== n.nodeType && !U.test(f + w.event.triggered) && (0 <= f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), a = f.indexOf(":") < 0 && "on" + f, (e = e[w.expando] ? e : new w.Event(f, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : w.makeArray(t, [e]), l = w.event.special[f] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
				if (!r && !l.noBubble && !w.isWindow(n)) {
					...
					o === (n.ownerDocument || v) && c.push(o.defaultView || o.parentWindow || h)
				}
				for (i = 0;
		...
		mouseHooks: {
			...
			filter: function(e, t) {
				var n, r, i = t.button;
				return null == e.pageX && null != t.clientX && (n = (r = e.target.ownerDocument || v).documentElement, r = r.body, e.pageX = t.clientX + (n && n.scrollLeft || r && r.scrollLeft || 0) - (n && n.clientLeft || r && r.clientLeft || 0), e.pageY = t.clientY + (n && n.scrollTop || r && r.scrollTop || 0) - (n && n.clientTop || r && r.clientTop || 0)), e.which || void 0 === i || (e.which = 1 & i ? 1 : 2 & i ? 3 : 4 & i ? 2 : 0), e
			}
		},
		fix: function(e) {
		...
		e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Y : G) : this.type = e, t && w.extend(this, t), this.timeStamp = e && e.timeStamp || w.now(), this[w.expando] = !0
	}, w.Event.prototype = {
	...
	oe.optgroup = oe.option, oe.tbody = oe.tfoot = oe.colgroup = oe.caption = oe.thead, oe.th = oe.td, w.extend({
		clone: function(e, t, n) {
			...
			if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (s = fe(c), r = 0, i = (o = fe(e)).length; r < i; r++) a = o[r], u = s[r], l = void 0, "input" === (l = u.nodeName.toLowerCase()) && I.test(a.type) ? u.checked = a.checked : "input" !== l && "textarea" !== l || (u.defaultValue = a.defaultValue);
			if (t) if (n) for (o = o || fe(e), s = s || fe(c), r = 0, i = o.length; r < i; r++) ce(o[r], s[r]);
			else ce(e, c);
			return 0 < (s = fe(c, "script")).length && le(s, !f && fe(e, "script")), c
		},
		buildFragment: function(e, t, n, r) {
			for (var i, o, s, a, u, l = t.createDocumentFragment(), c = [], f = 0, p = e.length; f < p; f++) if ((i = e[f]) || 0 === i) if ("object" === w.type(i)) w.merge(c, i.nodeType ? [i] : i);
			else if (Z.test(i)) {
		...
		domManip: function(n, r) {
			...
			var e, t, i, o, s, a, u = 0,
				...
				p = n[0],
				d = w.isFunction(p);
			if (d || 1 < l && "string" == typeof p && !y.checkClone && te.test(p)) return this.each(function(e) {
				var t = c.eq(e);
	...
	function Ee() {
		be.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", be.innerHTML = "", ve.appendChild(xe);
		var e = h.getComputedStyle(be, null);
		me = "1%" !== e.top, ye = "4px" === e.width, ve.removeChild(xe)
	}
	ve = v.documentElement, xe = v.createElement("div"), (be = v.createElement("div")).style && (be.style.backgroundClip = "content-box", be.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === be.style.backgroundClip, xe.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", xe.appendChild(be), h.getComputedStyle && w.extend(y, {
		...
		reliableMarginRight: function() {
			var e = be.appendChild(v.createElement("div"));
			return e.style.cssText = be.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", e.style.marginRight = e.style.width = "0", be.style.width = "1px", ve.appendChild(xe), e = !parseFloat(h.getComputedStyle(e, null).marginRight), ve.removeChild(xe), e
		}
	...
	w.extend({
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i, o, s, a = w.camelCase(t),
					u = e.style;
				if (t = w.cssProps[a] || (w.cssProps[a] = He(u, a)), s = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t];
				"string" === (o = typeof n) && (i = De.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(w.css(e, t)), o = "number"), null != n && n == n && ("number" !== o || w.cssNumber[a] || (n += "px"), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))
			}
		},
		css: function(e, t, n, r) {
			var i, o = w.camelCase(t);
			return t = w.cssProps[o] || (w.cssProps[o] = He(e.style, o)), (o = w.cssHooks[t] || w.cssHooks[o]) && "get" in o && (i = o.get(e, !0, n)), void 0 === i && (i = Ne(e, t, r)), "normal" === i && t in Le && (i = Le[t]), "" === n || n ? (t = parseFloat(i), !0 === n || w.isNumeric(t) ? t || 0 : i) : i
		}
	}), w.each(["height", "width"], function(e, i) {
		w.cssHooks[i] = {
			get: function(e, t, n) {
				if (t) return Se.test(w.css(e, "display")) && 0 === e.offsetWidth ? w.swap(e, Ae, function() {
					return Pe(e, i, n)
				}) : Pe(e, i, n)
			},
			set: function(e, t, n) {
	...
	}), w.cssHooks.marginRight = ke(y.reliableMarginRight, function(e, t) {
		...
		run: function(e) {
			...
			return this.options.duration ? this.pos = t = w.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), (n && n.set ? n : Re.propHooks._default).set(this), this
		}
	...
	var We, $e, Be = /^(?:toggle|show|hide)$/,
		...
		ze = [function(t, e, n) {
			var r, i, o, s, a, u, l, c = this,
				...
				d = t.nodeType && $(t),
				h = F.get(t, "fxshow");
			n.queue || (null == (a = w._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function() {
				a.unqueued || u()
			...
			1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === ("none" === (l = w.css(t, "display")) ? ge(t.nodeName) : l) && "none" === w.css(t, "float") && (p.display = "inline-block"));
			n.overflow && (p.overflow = "hidden", c.always(function() {
				p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
			}));
			for (r in e) if (i = e[r], Be.exec(i)) {
			...
			else for (r in h ? "hidden" in h && (d = h.hidden) : h = F.access(t, "fxshow", {}), o && (h.hidden = !d), d ? w(t).show() : c.done(function() {
				w(t).hide()
			}), c.done(function() {
		...
		Xe = {
			"*": [function(e, t) {
				var n = this.createTween(e, t),
					...
					s = 1,
					a = 20;
				if (o && o[3] !== i) for (i = i || o[3], t = t || [], o = +r || 1; o /= s = s || ".5", w.style(n.elem, e, o + i), s !== (s = n.cur() / r) && 1 !== s && --a;);
	...
	function Ye(e, t, n) {
		for (var r, i = (Xe[t] || []).concat(Xe["*"]), o = 0, s = i.length; o < s; o++) if (r = i[o].call(n, t, e)) return r
	}
	function Ge(i, e, t) {
		var n, o, r = 0,
			s = ze.length,
		...
		function(e, t) {
			var n, r, i, o, s;
			for (n in e) if (i = t[r = w.camelCase(n)], o = e[n], w.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = w.cssHooks[r]) && "expand" in s) for (n in o = s.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i);
			else t[r] = i
		}(c, l.opts.specialEasing); r < s; r++) if (n = ze[r].call(l, i, c, l.opts)) return n;
	...
	}, d = v.createElement("input"), s = v.createElement("select"), n = s.appendChild(v.createElement("option")), d.type = "checkbox", y.checkOn = "" !== d.value, y.optSelected = n.selected, s.disabled = !0, y.optDisabled = !n.disabled, (d = v.createElement("input")).value = "t", d.type = "radio", y.radioValue = "t" === d.value;
	...
	w.fn.extend({
		...
		attr: function(e, t, n) {
			...
			if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute == _ ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (t = t.toLowerCase(), r = w.attrHooks[t] || (w.expr.match.bool.test(t) ? Qe : void 0)), void 0 === n ? !(r && "get" in r && null !== (i = r.get(e, t))) && null == (i = w.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void w.removeAttr(e, t))
		},
	...
	w.fn.extend({
		...
		valHooks: {
			...
			select: {
				get: function(e) {
					for (var t, n = e.options, r = e.selectedIndex, i = "select-one" === e.type || r < 0, o = i ? null : [], s = i ? r + 1 : n.length, a = r < 0 ? s : i ? r : 0; a < s; a++) if (((t = n[a]).selected || a === r) && (y.optDisabled ? !t.disabled : null === t.getAttribute("disabled")) && (!t.parentNode.disabled || !w.nodeName(t.parentNode, "optgroup"))) {
	...
	try {
		...
		(it = v.createElement("a")).href = "", it = it.href
	}
	function ht(o) {
		return function(e, t) {
	...
	rt = ct.exec(it.toLowerCase()) || [], w.extend({
		...
		ajax: function(e, t) {
			...
			var u, l, c, n, f, p, r, d = w.ajaxSetup({}, t),
				...
				b = {
					...
					statusCode: function(e) {
						if (e) if (x < 2) for (var t in e) v[t] = [v[t], e[t]];
			...
			if (m.promise(b).complete = y.add, b.success = b.done, b.error = b.fail, d.url = ((e || d.url || it) + "").replace(ot, "").replace(lt, rt[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = w.trim(d.dataType || "*").toLowerCase().match(A) || [""], null == d.crossDomain && (e = ct.exec(d.url.toLowerCase()), d.crossDomain = !(!e || e[1] === rt[1] && e[2] === rt[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (rt[3] || ("http:" === rt[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), gt(ft, d, t, b), 2 === x) return b;
			...
			function a(e, t, n, r) {
				...
				}(d, s, b, r), r ? (d.ifModified && ((n = b.getResponseHeader("Last-Modified")) && (w.lastModified[l] = n), (n = b.getResponseHeader("etag")) && (w.etag[l] = n)), 204 === e || "HEAD" === d.type ? a = "nocontent" : 304 === e ? a = "notmodified" : (a = s.state, i = s.data, r = !(o = s.error))) : (o = a, !e && a || (a = "error", e < 0 && (e = 0))), b.status = e, b.statusText = (t || a) + "", r ? m.resolveWith(h, [i, a, b]) : m.rejectWith(h, [b, a, o]), b.statusCode(v), v = void 0, p && g.trigger(r ? "ajaxSuccess" : "ajaxError", [b, d, r ? i : o]), y.fireWith(h, [b, a]), p && (g.trigger("ajaxComplete", [b, d]), --w.active || w.event.trigger("ajaxStop")))
			}
			return b
		},
	...
	}), y.cors = !! kt && "withCredentials" in kt, y.ajax = kt = !! kt, w.ajaxTransport(function(o) {
		var s;
	...
	w.ajaxSetup({
		...
		if (s || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = w.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(St, "$1" + r) : !1 !== e.jsonp && (e.url += (nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
	...
	w.offset = {
		...
		w.cssHooks[n] = ke(y.pixelPosition, function(e, t) {
			if (t) return t = Ne(e, n), Te.test(t) ? w(e).position()[n] + "px" : t
		})
	}), w.each({
		Height: "height",
		Width: "width"
